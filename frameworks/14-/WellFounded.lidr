...
the most important examples of wf relations (e.g. < on Nat) and
some methods to build wf relations from others (see "Paulson - 1986 - 
Constructing Recursion Operators in Intuitionistic Type Theory")

contric/Control/WellFounded.lidr defines a type class wellFounded and
...
down a wellFounded-instance declaration for the inverse image of a
